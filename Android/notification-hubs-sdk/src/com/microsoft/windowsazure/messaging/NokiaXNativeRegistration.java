...
/**
 * Represents NokiaX native registration
 */
public class NokiaXNativeRegistration extends Registration{
	 ...
	 */
	NokiaXNativeRegistration(String notificationHubPath) {
	...
	protected void appendCustomPayload(Document doc, Element registrationDescription) {
		appendNodeWithValue(doc, registrationDescription, NOKIAX_HANDLE_NODE, getPNSHandle());
	}
